        ...
        $.effects.animateClass = function(value, duration, easing, callback) {
            ...
            return this.queue(function() {
                var animated = $(this),
                    ...
                    applyClassChange, allAnimations = o.children ? animated.find("*").andSelf() : animated;
...
(function($) {
    $.widget("ui.selectmenu", {
        ...
        _setOption: function(key, value) {
            ...
            if (key == 'disabled') {
                if (value) this.close();
                this.element.add(this.newelement).add(this.list)[value ? 'addClass' : 'removeClass']('ui-selectmenu-disabled ' + 'ui-state-disabled').attr("aria-disabled", value);
            }
        },
        ...
        _toggleOption: function(index, flag) {
            ...
            if (optionElem) {
                optionElem.toggleClass('ui-state-disabled', flag).find("a").attr("aria-disabled", !flag);
                if (flag) {
        ...
        _toggleOptgroup: function(index, flag) {
            ...
            if (optGroupElem) {
                optGroupElem.toggleClass('ui-state-disabled', flag).attr("aria-disabled", !flag);
                if (flag) {
        ...
        _refreshPosition: function() {
            ...
            this.listWrap.removeAttr('style').zIndex(this.element.zIndex() + 1).position($.extend(positionDefault, o.positionOptions));
        }
    });
})(jQuery);
