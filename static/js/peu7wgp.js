...
window.Typekit.config = {
    ...
    "f": "//use.typekit.net/c/a2070a/proxima-nova:i4:i6:i7:n4:n6:n7.W0W:N:2,Vn2:N:2,W0Z:N:2,W0V:N:2,W0X:N:2,W0Y:N:2/{format}{/extras*}?",
    "fn": ["proxima-nova", ["i4", "i6", "i7", "n4", "n6", "n7"]],
    "k": "//use.typekit.net/{id}.js",
    "p": "//p.typekit.net/p.gif?s=1&k=peu7wgp&ht=tk&h={host}&f=140.176.175.139.173.174&a=443363&_={_}",
    "w": "peu7wgp"
};
...
(function(window, document, undefined) {
    ...
    function ja(a, b, c) {
        ...
        if (d) {
            ...
            e.onload = e.onreadystatechange = function() {
                if (!f && (!this.readyState || "loaded" == this.readyState || "complete" == this.readyState)) f = h, c && c(k), e.onload = e.onreadystatechange = k, "HEAD" == e.parentNode.tagName && d.removeChild(e)
            };
            d.appendChild(e);
    ...
    la.prototype.parse = function() {
        ...
        } else /OPR\/[\d.]+/.test(this.e) ? a = pa(this) : /AppleWeb(K|k)it/.test(this.e) ?
    ...
    function xa(a, b, c) {
        for (var d in L)
            if (L.hasOwnProperty(d) && b === a.P[L[d]] && c === a.P[L[d]]) return h;
        return l
    }
    ...
    function Fa(a, b, c, d) {
        ...
        for (b = 0; b < a.length; b++) {
            for (var e = a[b], f = e.L, g = l, j = 0; j < c.length; j++) c[j] == f && (g = h);
            g || (c.push(f), d[f] = e.H())
        }
    }
    ...
    Xa.i = new Sa(function(a, b, c) {
        ...
        d = {};
        a = [];
        for (e = 0; e < c.length; e++) f = c[e], d[f] || (d[f] = h, a.push(f));
        c = [];
    ...
    W.prototype.load = function(a, b) {
        if (this.t) {
            for (var c = Xa[this.t] || new Sa(Ta), d = 0; d < this.v.length; d++) {
                for (var e = this.v[d], f = this.t, g = c, j = [], p = e.L.split(",")[0].replace(/"|'/g, ""), z = e.H(), ca = j, B = void 0, S = [], I = {}, ma = 0; ma < z.length; ma++) B = z[ma], 0 < B.length && !I[B] && (I[B] = h, S.push(B));
                z = S;
    ...
    W.prototype.collectFontFamilies = function(a, b) {
        if (this.t)
            for (var c = 0; c < this.v.length; c++) Fa(this.v[c], this.t, a, b)
    };
            ...
            if (d) {
                ...
                for (var f = new M(a.e, a.j, c), c = function(a, b, c) {
                        for (var d = [], e = 0; e < a.length; e += 1) {
                            var B = a[e];
                            if (b[B])
                                for (var S = b[B], I = 0; I < S.length; I += 1) d.push(new J(B, S[I]));
                            else d.push(new J(B))
                        }
                        f.fa(d, {}, k, c)
        ...
        if (a)
            for (var b = 0; b < this.u.length; b++) {
                ...
                d && d(function(a, b, d) {
                    a = [];
                    b = {};
                    var j = (new la(navigator.userAgent, document)).parse(),
                        p = c;
                    p.e = j;
                    p.t = Wa(p.e, p.Z);
    ...
    if (!window.Typekit.load) {
        ...
        eb.k && (fb = new O(eb.k));
        var X = new Ya(fb, new ga(window), db, document.documentElement),
            gb = new $a(window);
    ...
    var i;
    if (N.fn)
        for (i = 0; i < N.fn.length; i += 2) $.v.push(new Ea(N.fn[i], N.fn[i + 1]));
    if (N.c)
